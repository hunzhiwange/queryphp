...
final class CartEntityTest extends TestCase
{
    public function test1(): void
    {
        ...
        $cartItemDto = new CartItemEntity([
            'inventory_id' => 999,
            'number' => 3,
        ...
        $cartDto = new CartEntity();
        $cartDto->addItem($cartItemDto);
        $cartItemPromotionDto = new CartItemPromotionEntity([
            'promotion_id' => 1,
            'promotion_name' => '秒杀活动',
            'promotion_price' => 8,
        ]);
        $cartDto->addPromotion($cartItemPromotionDto, $cartItemDto);
        ...
        $cartItemDto->disable();
        static::assertSame($cartDto->getActivePurchaseTotalPrice(), 0.0);
        static::assertSame($cartDto->getPurchaseTotalPrice(), 24.0);

        $cartDto->increment($cartItemDto->generateHash(), 5);
        $cartItemDto->enable();
        static::assertSame($cartDto->getActivePurchaseTotalPrice(), 64.0);
        static::assertSame($cartDto->getPurchaseTotalPrice(), 64.0);
    }
    ...
    public function test2(): void
    {
        ...
        $cartItemDto2 = new CartItemEntity([
            'inventory_id' => 3,
            'number' => 2,
            'price' => new CartItemPriceEntity([
                'sales_price' => 30,
        ...
        $cartItemDto3 = new CartItemEntity([
            'inventory_id' => 5,
            'number' => 1,
            'price' => new CartItemPriceEntity([
                'sales_price' => 50,
        ...
        $cartDto->addPromotion($cartItemPromotionDto, $cartItemDto, $cartItemDto2);
        $cartDto->calculatePrice();
        ...
        $cartPriceDto = new CartPriceEntity();
    ...
    public function test2Sub1(): void
    {
        ...
        $cartDto->addPromotion($cartItemPromotionDto, $cartItemDto);
        $cartDto->addPromotion($cartItemPromotionDto, $cartItemDto2);
        $cartDto->calculatePrice();
