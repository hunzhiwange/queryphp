...
final class ProjectTag extends AbstractMigration
{
    ...
    {
        $this->table('project_tag')->drop()->save();
    }
    ...
    private function struct(): void
    {
        $sql = <<<'EOT'
            CREATE TABLE `project_tag` (
                ...
                `color` char(7) NOT NULL DEFAULT '' COMMENT '标签颜色',
                ...
                KEY `idx_project` (`platform_id`,`company_id`,`project_id`,`delete_at`,`status`) USING BTREE
