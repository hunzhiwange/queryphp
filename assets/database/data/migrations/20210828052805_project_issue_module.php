    ...
    private function struct(): void
    {
        $sql = <<<'EOT'
            CREATE TABLE `project_issue_module` (
                ...
                `project_module_id` bigint(20) unsigned NOT NULL DEFAULT '0' COMMENT '项目模块ID',
                ...
                PRIMARY KEY (`id`),
                UNIQUE KEY `uniq_issue_release` (`platform_id`,`company_id`,`project_issue_id`,`project_module_id`,`delete_at`) USING BTREE
