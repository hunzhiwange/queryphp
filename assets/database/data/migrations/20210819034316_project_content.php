...
final class ProjectContent extends AbstractMigration
{
    ...
    {
        \App\Infra\Helper\BatchDropTable::handle($this, 'project_content[database_data_index]');
    }

    private function struct(): void
    {
        $sql = <<<'EOT'
            CREATE TABLE `project_content[database_data_index]` (
                ...
                `project_issue_id` bigint(20) unsigned NOT NULL DEFAULT '0' COMMENT '问题ID',
                ...
                PRIMARY KEY (`id`),
                KEY `idx_platform_company` (`platform_id`,`company_id`,`project_id`,`project_issue_id`,`delete_at`) USING BTREE
