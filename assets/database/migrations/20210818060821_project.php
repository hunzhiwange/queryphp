    ...
    private function struct(): void
    {
        $sql = <<<'EOT'
            CREATE TABLE `project` (
                ...
                `owner_user_id` varchar(100) DEFAULT '' COMMENT '项目所有者用户 ID',
                `completed_number` bigint(20) DEFAULT 0 COMMENT '已完成任务数量',
                `unfinished_number` bigint(20) DEFAULT 0 COMMENT '未完成任务数量',
