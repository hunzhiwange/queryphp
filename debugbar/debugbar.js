...
;(function($) {
  ...
  var Tab = Widget.extend({
    ...
    render: function() {
      ...
      this.bindAttr(
        'title',
        $('<span />')
          .addClass(csscls('text'))
          .appendTo(this.$tab)
      )

      this.$badge = $('<span />')
        .addClass(csscls('badge'))
        .appendTo(this.$tab)
  ...
  var Indicator = Widget.extend({
    ...
    render: function() {
      ...
      this.$tooltip = $('<span />')
        .addClass(csscls('tooltip disabled'))
        .appendTo(this.$el)
  ...
  var DebugBar = (PhpDebugBar.DebugBar = Widget.extend({
    ...
    render: function() {
      ...
      this.$dragCapture = $('<div />')
        .addClass(csscls('drag-capture'))
        .appendTo(this.$el)
      this.$resizehdle = $('<div />')
        .addClass(csscls('resize-handle'))
        .appendTo(this.$el)
      this.$header = $('<div />')
        .addClass(csscls('header'))
        .appendTo(this.$el)
      this.$headerLeft = $('<div />')
        .addClass(csscls('header-left'))
        .appendTo(this.$header)
      this.$headerRight = $('<div />')
        .addClass(csscls('header-right'))
        .appendTo(this.$header)
      var $body = (this.$body = $('<div />')
        .addClass(csscls('body'))
        .appendTo(this.$el))
      ...
      this.$datasets = $('<select />')
        .addClass(csscls('datasets-switcher'))
        .appendTo(this.$headerRight)
    ...
    showTab: function(name) {
      ...
      $(this.$header)
        .find('> div > .' + csscls('active'))
        .removeClass(csscls('active'))
      $(this.$body)
        .find('> .' + csscls('active'))
        .removeClass(csscls('active'))
