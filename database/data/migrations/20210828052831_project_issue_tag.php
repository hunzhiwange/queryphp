    ...
    private function struct(): void
    {
        $sql = <<<'EOT'
            CREATE TABLE `project_issue_tag` (
                ...
                `project_tag_id` bigint(20) unsigned NOT NULL DEFAULT '0' COMMENT '项目标签ID',
                ...
                PRIMARY KEY (`id`),
                UNIQUE KEY `uniq_issue_tag` (`platform_id`,`company_id`,`project_issue_id`,`project_tag_id`,`delete_at`) USING BTREE
