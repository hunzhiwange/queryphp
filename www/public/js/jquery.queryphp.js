...
(function($, window, document, undefined) {
    ...
    queryphp.prototype = {
        ...
        /**
         * 框架 Javascript 生成函数 < 本函数用 Js 版本的 URL生成函数，使用方法见头部注释
         * $Q.url('app://admin.php*module/action?param1=1&param1=2',{extraparam:'hello',extraparam2:'hello2',extraparam3:'hello3'});
         * $Q.url('@://module/action?param1=1&param1=2',{extraparam:'hello',extraparam2:'hello2',extraparam3:'hello3'});
         * $Q.url('module/action?param1=1&param1=2',{extraparam:'hello',extraparam2:'hello2',extraparam3:'hello3'}); >
         * 
         * @param string
         *            strUrl 初始化URL
