...
<div>
    ...
    <div class="content-main2">
        ...
        <el-tree class="filter-tree" :data="dataTree" :props="defaultProps" :filter-node-method="filterNode" ref="tree" node-key="id" show-checkbox default-expand-all highlight-current :check-strictly="checkStrictly" :render-content="renderContent">
        </el-tree>
