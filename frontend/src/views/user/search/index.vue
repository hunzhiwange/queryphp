    ...
    <div class="search-wrap">
        <Row :gutter="16">
            <i-col span="18">
                <Row :gutter="16">
                    ...
                    <i-col span="6">
                        ...
                        <i-button type="ghost" icon="refresh" @click.native.prevent="reset()" class="m-r-5">{{ __('重置') }}</i-button>
            ...
            <i-col span="2" style="text-align:right">
                <i-button size="small" type="text" @click="add()" class="add-extra"><Icon type="android-add-circle"></Icon> {{ __('新增') }}</i-button>
            </i-col>
        </Row>
    </div>
</template>
