            ...
            columns: [
                ...
                },
                {
                    ...
                    render: (h, params) => {
                        ...
                        return (<tag type="dot" color={row.status === 'enable' ? 'green' : 'default'}>{row.status_name}</tag>)
                    }
                },
                {
                    title: '操作',
    ...
    methods: {
        ...
        remove(params) {
            this.$Modal.confirm({
                ...
                onOk: () => {
                    this.apiDelete('position_category', params.row.id).then((res) => {
        ...
        saveCategory(form) {
            this.apiPost('position_category', this.formItem).then((res) => {
                const addNode = {
                    name: res.data.name,
                    id: res.data.id,
