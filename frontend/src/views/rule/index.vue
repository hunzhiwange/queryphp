    ...
    <Row>
                    ...
                    <Form ref="form" :rules="rules" :model="formItem" :label-width="110" class="w-1000">
                        <Row :gutter="16">
                            <Col span="12">
                                ...
                                <FormItem :label="__('权限类型')" prop="type">
                                    <RadioGroup v-model="formItem.type">
                                        <Radio label="app" :disabled='this.typeDisabled'>{{__('应用')}}</Radio>
                                        <Radio label="category" :disabled='this.typeDisabled'>{{__('权限分组')}}</Radio>
                                        <Radio label="rule" :disabled='this.typeDisabled'>{{__('权限')}}</Radio>
                                    </RadioGroup>
                                </FormItem>
        ...
        <Card>
            ...
            <div>
                <Row>
                    <Col span="24">
                    <Tree :data="dataTree" ref="tree" show-checkbox multiple :render="renderContent" class="main-tree"></Tree>
                    </Col>
                </Row>
            </div>
        </Card>
