    ...
    methods: {
        ...
        remove(params) {
            this.$Modal.confirm({
                ...
                content: __('确认删除该权限?'),
                onOk: () => {
                    this.apiDelete('permission', params.row.id).then(res => {
        ...
        statusMany(type) {
            ...
            this.apiPost('permission/status', data).then(res => {
        ...
        saveResource(form) {
            ...
            this.apiPost('permission', formData).then(
                res => {
                    const addNode = {
                        name: res.name,
        ...
        updateResource(form) {
            ...
            this.apiPut('permission', this.formItem.id, formData).then(
                res => {
                    this.data.forEach((item, index) => {
