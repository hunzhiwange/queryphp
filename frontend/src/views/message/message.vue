        ...
        <div class="message-mainlist-con">
            <div>
                <i-button @click="setCurrentMesType('unread')" size="large" long type="text"
                    ><transition name="mes-current-type-btn"
                        ><Icon v-show="currentMessageType === 'unread'" type="checkmark"></Icon></transition
            ...
            <div>
                <i-button @click="setCurrentMesType('hasread')" size="large" long type="text"
                    ><transition name="mes-current-type-btn"
                        ><Icon v-show="currentMessageType === 'hasread'" type="checkmark"></Icon></transition
            ...
            <div>
                <i-button @click="setCurrentMesType('recyclebin')" size="large" long type="text"
                    ><transition name="mes-current-type-btn"
                        ><Icon v-show="currentMessageType === 'recyclebin'" type="checkmark"></Icon></transition
                ...
                <div v-if="!showMesTitleList" class="message-view-content-con">
                    <div class="message-content-top-bar">
                        <span class="mes-back-btn-con"
                            ><i-button type="text" @click="backMesTitleList"
                                ><Icon type="chevron-left"></Icon>&nbsp;&nbsp;{{ __('返回') }}</i-button
                            ></span
                        >
...
<style lang="less" src="./assets/message.less"></style>
