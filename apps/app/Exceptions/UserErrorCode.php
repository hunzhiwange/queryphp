...
enum UserErrorCode:int
{
    ...
    #[msg('权限包含子项不能够被删除')]
    case PERMISSION_CONTAINS_SUBKEY_AND_CANNOT_BE_DELETED = 1000010004;
    ...
    #[msg('锁定管理面板参数错误')]
    case LOCK_ANAGEMENT_PANEL_INVALID_ARGUMENT = 1000010012;

    #[msg('解锁管理面板参数错误')]
    case UNLOCK_ANAGEMENT_PANEL_INVALID_ARGUMENT = 1000010013;
